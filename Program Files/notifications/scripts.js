...
function refreshNotifications() {
  ...
  for (i = 0; i < notifications.length; i++) {
    ...
    objects.notifications.innerHTML = objects.notifications.innerHTML + "<div class='a_notificaton'><h3>" + thisnotification.title + "</h3><button class='rm_not' onclick='remove_notification(" + i + ")'>x</button><p>" + thisnotification.content + "</p></div>";
  }
